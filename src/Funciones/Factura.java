...
public class Factura{
    ...
    String directorio;
    public Factura(String nombre, String direccion, String rfc, String telefono,String[] lista,  String [] articulos, String [] precios, String[] precunit) throws FileNotFoundException, DocumentException{
        ...
        documento.add(new Paragraph("R.F.C: "+rfc));
        ...
        parrafo6.setAlignment(Element.ALIGN_RIGHT);
