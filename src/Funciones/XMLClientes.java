...
public class XMLClientes extends DefaultTableModel {        
    public File xml = null;  
    public Document dom = null;   
    public JScrollPane jScrollPane1;  
      
    public XMLClientes(){  
        xml = new File(System.getProperty("user.dir") + File.separator + "clientes.xml");          
    ...
    public void insertTableRows(DefaultTableModel tableModel,Document doc) {              
        ...
        for (int i = 0; i < list.getLength(); ++i) {  
            ...
            if (e.getNodeType() == Element.ELEMENT_NODE) {  
                Object[] row = { getArticleInfo("Nombre",e),getArticleInfo("Direccion",e),getArticleInfo("rfc",e),getArticleInfo("Telefono",e) };  
